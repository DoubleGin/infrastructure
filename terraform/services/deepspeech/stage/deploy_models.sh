...
gsutil -m cp deepspeech-0.7.4-models.pbmm gs://oddmark-deepspeech-transcripts-stage/
gsutil -m cp deepspeech-0.7.4-models.scorer gs://oddmark-deepspeech-transcripts-stage/
